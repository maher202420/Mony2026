...
object GeminiClient {
    ...
    suspend fun getChatbotResponse(prompt: String, chatHistory: List<Pair<String, String>> = emptyList()): String {
        ...
        val systemPrompt = """
            ...
            الاسم الاختصاري: WAM
            المالك والمشرف العام: الأستاذ ماهر عادل العقبي.
            رقم الهاتف للتواصل والدعم الفني: 777644670 (وهو اسم رقم الدعاية أيضاً).
            ...
            2. سحب وإيداع نقدي فوري عبر الوكلاء المرخصين مثل شركة الصيفي للصرافة.
            3. دفع فواتير الخدمات فورا (الكهرباء، المياه، الهاتف الثابت) وشحن الرصيد المباشر لكافة الشبكات المحلية (يمن موبايل، يو YOU، سبأفون، واي).
            ...
            8. توفير قروض تمويلية أصغر ذكية بدون ضمانات كلاسيكية معتمدة على تحليل السلوك والذكاء الاصطناعي للمالك ماهر عادل العقبي.
